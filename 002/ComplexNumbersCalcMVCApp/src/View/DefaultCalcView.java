...
public class DefaultCalcView implements iCalcView<ComplexNumber> {
    ...
    public void showLabel() {
        System.out.println("+------------- There's the calc app. --+");
        System.out.println("|-- You can type two complex numbers --|");
        System.out.println("|-- Example: (1 + 7i) or (7 + 1.25i) --|");
        System.out.println("|-- Then use commands below to: -------|");
